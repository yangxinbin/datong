...
import static www.mangosis.com.datong.waimai.listdetail.WaiMaiListMainActivity.CLEARCAR_ACTION;

public class DetailActivity extends WaiMaiBaseActivity implements AddWidget.OnAddClick {
	...
	private void initShopCar() {
		...
		flist.addAll(WaiMaiListMainActivity.carAdapter.getData());
	...
	private void dealCar(FoodBean foodBean) {
		...
		Intent intent = new Intent(WaiMaiListMainActivity.CAR_ACTION);
