package www.mangosis.com.datong.view;
...
public class WaiMaiBottomBar extends View {

    private Context context;

    public WaiMaiBottomBar(Context context, @Nullable AttributeSet attrs) {
        super(context, attrs);
    ...
    private int iconHeight = 23;
    private int titleIconMargin = 5;

    public WaiMaiBottomBar setContainer(int containerId) {
        this.containerId = containerId;
        return this;
    }

    public WaiMaiBottomBar setTitleBeforeAndAfterColor(String beforeResCode, String AfterResCode) {//支持"#333333"这种形式
        titleColorBefore = Color.parseColor(beforeResCode);
        titleColorAfter = Color.parseColor(AfterResCode);
        return this;
    }

    public WaiMaiBottomBar setTitleSize(int titleSizeInDp) {
        this.titleSizeInDp = titleSizeInDp;
        return this;
    }

    public WaiMaiBottomBar setIconWidth(int iconWidth) {
        this.iconWidth = iconWidth;
        return this;
    }

    public WaiMaiBottomBar setTitleIconMargin(int titleIconMargin) {
        this.titleIconMargin = titleIconMargin;
        return this;
    }

    public WaiMaiBottomBar setIconHeight(int iconHeight) {
        this.iconHeight = iconHeight;
        return this;
    }

    public WaiMaiBottomBar addItem(Class fragmentClass, String title, int iconResBefore, int iconResAfter) {
    ...
    public WaiMaiBottomBar setFirstChecked(int firstCheckedIndex) {//从0开始
