package www.mangosis.com.datong.waimai.listdetail.utils;
...
import www.mangosis.com.datong.waimai.listdetail.bean.TypeBean;
...
public class BaseUtils {
	...
	public static List<FoodBean> getDatas(Context context) {
		...
		for (int i = 0; i < 91; i++) {
			...
			int resID = context.getResources().getIdentifier("food" + new Random().nextInt(8), "drawable", "www.mangosis.com.datong");
