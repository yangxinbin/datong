...
public class RadioItemView extends RelativeLayout implements View.OnClickListener{
    ...
    protected void onFinishInflate() {
        ...
        mTitleText = (TextView) findViewById(R.id.re_title);
    ...
    public void setSelected(boolean bool){
        ...
        if(bool){
            mSelectedImage.setBackgroundResource(R.drawable.ic_rcheck);
        }else{
           mSelectedImage.setBackgroundResource(R.drawable.ic_no_rcheak);
        }
