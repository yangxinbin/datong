...
import www.mangosis.com.datong.waimai.home.PlateWaiMaiFragment;

public class IndexCircleShowMeiShiFragment extends Fragment {
    Context context;
    int pointIndex = 0;
    View view = null;
...
//        用来触发监听器
        ...
        indexFragmentPagerAdapter.addFragment(new PlateMeiShiFragment());
