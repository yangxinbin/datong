package www.mangosis.com.datong.waimai.listdetail;
...
import www.mangosis.com.datong.waimai.listdetail.Views.ShopCarView;
import www.mangosis.com.datong.waimai.listdetail.Views.ShopInfoContainer;
import www.mangosis.com.datong.waimai.listdetail.adapters.CarAdapter;
import www.mangosis.com.datong.waimai.listdetail.bean.FoodBean;
import www.mangosis.com.datong.waimai.listdetail.behaviors.AppBarBehavior;
...
public class WaiMaiListMainActivity extends WaiMaiBaseActivity implements AddWidget.OnAddClick {
    ...
    protected int getLayoutId() {
        return R.layout.waimaiactivity_main;
    }
...
//		carRecView.setNestedScrollingEnabled(false);
    ...
    public void toShopDetail(View view) {
        ...
        if (android.os.Build.VERSION.SDK_INT > 20) {
            startActivity(new Intent(mContext, ShopDetailActivity.class), ActivityOptions.makeSceneTransitionAnimation(WaiMaiListMainActivity.this, shopInfoContainer.iv_shop, "transitionShopImg").toBundle());
        } else {
