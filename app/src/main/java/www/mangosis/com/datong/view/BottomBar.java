        ...
        if (itemCount != 0) {
            ...
            for (int i = 0; i < itemCount; i++) {
                ...
                if (i == currentCheckedIndex) {
                    ...
                    //bitmap.setHeight(dp2px(this.iconWidth+2));
                    //bitmap.setWidth(dp2px(this.iconWidth+2));
                } else {
                    bitmap = iconBitmapBeforeList.get(i);
                    //bitmap.setHeight(dp2px(this.iconWidth));
                    //bitmap.setWidth(dp2px(this.iconWidth));
                }
