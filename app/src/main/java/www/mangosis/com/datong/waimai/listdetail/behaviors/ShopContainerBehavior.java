package www.mangosis.com.datong.waimai.listdetail.behaviors;
...
public class ShopContainerBehavior extends CoordinatorLayout.Behavior<ShopInfoContainer> {
	...
	private void shouldInitProperties() {
		...
		int statusBarHeight = www.mangosis.com.datong.waimai.listdetail.utils.ViewUtils.getStatusBarHeight(mContext);
		int acBarHeight = www.mangosis.com.datong.waimai.listdetail.utils.ViewUtils.dip2px(mContext, 56);
